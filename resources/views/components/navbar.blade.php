<nav class="navbar navbar-expand-lg bg-blu shadow">
    <div class="container-fluid">
      <a class="navbar-brand ms-5 text-chromeyellow fw-bolder text-shadow" href="#"><i class="fas fa-shopping-bag"></i> PRESTO.it</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto me-5 mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-chromeyellow text-shadow" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Benvenuto,
            </a>
